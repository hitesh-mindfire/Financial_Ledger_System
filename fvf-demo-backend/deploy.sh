...
kubectl apply -f ./postgres-k8s/kubernetes/postgres-configmap.yaml
kubectl apply -f ./postgres-k8s/kubernetes/postgres-secret.yaml
kubectl apply -f ./postgres-k8s/kubernetes/postgres-storage.yaml
kubectl apply -f ./postgres-k8s/kubernetes/postgres-deployment.yaml
kubectl apply -f ./postgres-k8s/kubernetes/postgres-service.yaml
